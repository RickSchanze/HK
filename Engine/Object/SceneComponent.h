...
protected:
    ...
    // 相对于Owner的本地Transform
    HPROPERTY()
    FTransform LocalTransform;

    // 为true时更新LocalTransform和WorldTransform
     ...
     * @param ParentTransform 父级的世界 Transform（如果是 Actor 的 Component，则为 Actor 的 Transform）
     */
    void UpdateWorldTransform(const FTransform& ParentTransform);
